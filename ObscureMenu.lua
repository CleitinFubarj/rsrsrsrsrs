...
if not game:IsLoaded() then
    ...
    notLoaded.Text = "Obscure Menu está esperando o jogo carregar"
    game.Loaded:Wait()
    notLoaded:Destroy()
end
...
Directions.Text = "Clique no botão abaixo e pressione uma tecla/botão do mouse. Então selecione a que você quer vinculá-lo."
...
ClickTP.Name = "Click TP (Segure a tecla e clique)"
...
ClickTP.Text = "    Click TP (Segure a tecla e clique)"
...
ClickDelete.Name = "Click Delete (Segure a tecla e clique)"
...
ClickDelete.Text = "    Click Delete (Segure a tecla e clique)"
...
addcmd('clearnilinstances',{'nonilinstances','cni'},function(args, speaker)
	if getnilinstances then
		...
		notify('Exploit incompatível','Seu exploit não suporta este comando (getnilinstances ausente)')
	end
end)
